...
__all__ = [
    'send_saldo_erp', 'send_cuentas_erp', 'send_transacciones_erp', 'get_transacciones_erp',
    'set_conciliacion_app',
]


class ConciliacionesAPI:
    BASE_URL = "http://bancos.rpamaker.com/api"
    ...
    def authenticate(self):
        ...
        payload = {"username": "legamar_bot", "password": "bot123456!"}
